...
##### 1: N-TERMINUS ############################################################
  ...
  mer <- BuildTrainTest("output/CKR_MOTIF_MATRIX.csv", 100, 0.8)
  train <- mer[[1]]
  test <- mer[[2]]
  ...
  # RUN 2
  # import, split to training, test sets
  mer <- BuildTrainTest("output/CKR_MOTIF_MATRIX.csv", 200, 0.8)
  train <- mer[[1]]
  test <- mer[[2]]
  train <- train %>% select(-file, -protein)
  test <- test %>% select(-file, -protein)
  ...
  # RUN 3
  # import, split to training, test sets
  mer <- BuildTrainTest("output/CKR_MOTIF_MATRIX.csv", 300, 0.8)
  train <- mer[[1]]
  test <- mer[[2]]
  train <- train %>% select(-file, -protein)
  test <- test %>% select(-file, -protein)
...
##### 2: ECL2 ##################################################################
  ...
  # RUN 1
  # import, split to training, test sets
  mer <- BuildTrainTest("output/CKR_MOTIF_MATRIX_ECL2.csv", 100, 0.8)
  train <- mer[[1]]
  test <- mer[[2]]
  train <- train %>% select(-seqid, -protein)
  test <- test %>% select(-seqid, -protein)
  ...
  # RUN 2
  # import, split to training, test sets
  mer <- BuildTrainTest("output/CKR_MOTIF_MATRIX_ECL2.csv", 200, 0.8)
  train <- mer[[1]]
  test <- mer[[2]]
  train <- train %>% select(-seqid, -protein)
  test <- test %>% select(-seqid, -protein)
  ...
  # RUN 3
  # import, split to training, test sets
  mer <- BuildTrainTest("output/CKR_MOTIF_MATRIX_ECL2.csv", 300, 0.8)
  train <- mer[[1]]
  test <- mer[[2]]
  train <- train %>% select(-seqid, -protein)
  test <- test %>% select(-seqid, -protein)
